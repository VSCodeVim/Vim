...
| Status                    | Command   | Description                                   | Note                                                                                                           |
| ------------------------- | --------- | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| :white_check_mark: :star: | :1234: zh | scroll screen N characters to the left        | In Code, the cursor will always move when you run this command, whether the horizontal scrollbar moves or not. |
| :white_check_mark: :star: | :1234: zl | scroll screen N characters to the right       | As above                                                                                                       |
| :white_check_mark: :star: | :1234: zH | scroll screen half a screenwidth to the left  | As above                                                                                                       |
| :white_check_mark: :star: | :1234: zL | scroll screen half a screenwidth to the right | As above                                                                                                       |
