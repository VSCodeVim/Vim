...
| vim.useSystemClipboard           | Replace the unnamed register with the system clipboard. Pressing d/y/p alone in normal mode will use VS Code's native cut/copy/paste functionality instead of a Vim register.                                                                                                                                                                                                                                                       | Boolean | false                                 |
