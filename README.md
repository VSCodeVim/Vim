...
> :warning: This functionality overrides the configurations in your workspace settings.jston resulting in increased latency and a constant changing diff in your working directory (see [issue#2124](https://github.com/VSCodeVim/Vim/issues/2124)).
