...
export class NormalMode extends Mode {
    protected keyHandler : { [key : string] : (motion : Motion) => Promise<{}>; } = {
        ...
        "h" : async (c) => { return await vscode.commands.executeCommand("cursorLeft"); },
        "j" : async (c) => { return await vscode.commands.executeCommand("cursorDown"); },
        "k" : async (c) => { return await vscode.commands.executeCommand("cursorUp"); },
        "l" : async (c) => { return await vscode.commands.executeCommand("cursorRight"); },
