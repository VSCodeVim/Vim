import { RecordedState, VimState } from 'src/mode/modeHandler';
import { SearchState, SearchDirection } from 'src/state/searchState';
import { ReplaceState } from 'src/state/replaceState';
import { VisualBlockMode } from 'src/mode/modeVisualBlock';
import { ModeName } from 'src/mode/mode';
import { VisualBlockInsertionType } from 'src/mode/modeVisualBlock';
import { Range } from 'src/common/motion/range';
import { TextEditor, EditorScrollByUnit, EditorScrollDirection } from 'src/textEditor';
import { Register, RegisterMode } from 'src/register/register';
import { NumericString } from 'src/common/number/numericString';
import { Position, PositionDiff } from 'src/common/motion/position';
import { Tab, TabCommand } from 'src/cmd_line/commands/tab';
import { Configuration } from 'src/configuration/configuration';
import { allowVSCodeToPropagateCursorUpdatesAndReturnThem } from 'src/util';
import { isTextTransformation } from 'src/transformations/transformations';
