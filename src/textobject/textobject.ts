...
/**
 * This class creates text objects based on the syntax symbols generated by
 * VsCode's LSP.  This allows to easily select class objects or functions for
 * example by inheriting it and creating a whitelist.
 */
abstract class SelectASymbol extends TextObject {
