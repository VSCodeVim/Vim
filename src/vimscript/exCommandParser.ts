...
import { MapCommand } from '../cmd_line/commands/map';
...
export const builtinExCommands: ReadonlyArray<[[string, string], ArgParser | undefined]> = [
  ...
  [['cm', 'ap'], MapCommand.argParser('map', 'c')],
  [['cmapc', 'lear'], MapCommand.argParser('mapclear', 'c')],
  [['cme', 'nu'], undefined],
  ...
  [['cno', 'remap'], MapCommand.argParser('noremap', 'c')],
  ...
  [['cs', 'cope'], undefined],
  [['cst', 'ag'], undefined],
  [['cu', 'nmap'], MapCommand.argParser('unmap', 'c')],
  ...
  [['ij', 'ump'], undefined],
  [['il', 'ist'], undefined],
  [['im', 'ap'], MapCommand.argParser('map', 'i')],
  [['imapc', 'lear'], MapCommand.argParser('mapclear', 'i')],
  [['ime', 'nu'], undefined],
  [['ino', 'remap'], MapCommand.argParser('noremap', 'i')],
  [['inorea', 'bbrev'], undefined],
  [['inoreme', 'nu'], undefined],
  [['int', 'ro'], undefined],
  [['is', 'earch'], undefined],
  [['isp', 'lit'], undefined],
  [['iu', 'nmap'], MapCommand.argParser('unmap', 'i')],
  ...
  [['mak', 'e'], undefined],
  [['map', ''], MapCommand.argParser('map', '')],
  [['mapc', 'lear'], MapCommand.argParser('mapclear', '')],
  ...
  [['nm', 'ap'], MapCommand.argParser('map', 'n')],
  [['nmapc', 'lear'], MapCommand.argParser('mapclear', 'n')],
  [['nme', 'nu'], undefined],
  [['nn', 'oremap'], MapCommand.argParser('noremap', 'n')],
  [['nnoreme', 'nu'], undefined],
  [['no', 'remap'], MapCommand.argParser('noremap', '')],
  ...
  [['nun', 'map'], MapCommand.argParser('unmap', 'n')],
  [['nunme', 'nu'], undefined],
  [['ol', 'dfiles'], undefined],
  [['om', 'ap'], MapCommand.argParser('map', 'o')],
  [['omapc', 'lear'], MapCommand.argParser('mapclear', 'o')],
  [['ome', 'nu'], undefined],
  [['on', 'ly'], succeed(new OnlyCommand())],
  [['ono', 'remap'], MapCommand.argParser('noremap', 'c')],
  [['onoreme', 'nu'], undefined],
  [['opt', 'ions'], undefined],
  [['ou', 'nmap'], MapCommand.argParser('unmap', 'o')],
  [['ounme', 'nu'], undefined],
  ...
  [['unm', 'ap'], MapCommand.argParser('unmap', '')],
  [['unme', 'nu'], undefined],
  [['uns', 'ilent'], undefined],
  ...
  [['viu', 'sage'], undefined],
  [['vm', 'ap'], MapCommand.argParser('map', 'v')],
  [['vmapc', 'lear'], MapCommand.argParser('mapclear', 'v')],
  [['vme', 'nu'], undefined],
  [['vn', 'oremap'], MapCommand.argParser('noremap', 'v')],
  ...
  [['vu', 'nmap'], MapCommand.argParser('unmap', 'v')],
  [['vunme', 'nu'], undefined],
  ...
  [['xm', 'ap'], MapCommand.argParser('map', 'x')],
  [['xmapc', 'lear'], MapCommand.argParser('mapclear', 'x')],
  [['xme', 'nu'], undefined],
  [['xn', 'oremap'], MapCommand.argParser('noremap', 'x')],
  [['xnoreme', 'nu'], undefined],
  [['xu', 'nmap'], MapCommand.argParser('unmap', 'x')],
  [['xunme', 'nu'], undefined],
