...
| ------------------ | -------------- |---------------------------------------------------------------- |
| :white_check_mark: | :1234: h       | 左移 (also: CTRL-H, BS, or Left key)                             |
| :white_check_mark: | :1234: l       | 右移 (also: Space or Right key)                                  |
| :white_check_mark: | 0              | 移动到当前行的第一个字符处 (also: Home key)                         |
| :white_check_mark: | ^              | 移动到当前行的第一个非空字符处                                       |
| :white_check_mark: | :1234: \$      | 移动到当前行的最后一个字符处 (N-1 lines lower) (also: End key)       |
...
| :white_check_mark: | :1234: \|      | 移动到指定列 (default: 1)                                         |
...
| Status             | Command   | Description                                                                               |
| ------------------ | --------- | ----------------------------------------------------------------------------------------- |
| :white_check_mark: | :1234: k  | 上移 (also: CTRL-P and Up)                              |
| :white_check_mark: | :1234: j  | 下移 (also: CTRL-J, CTRL-N, NL, and Down)               |
| :white_check_mark: | :1234: -  | 上移，光标将位于第一个非空白字符上                           |
| :white_check_mark: | :1234: +  | 下移，光标将位于第一个非空白字符上 (also: CTRL-M and CR)     |
| :white_check_mark: | :1234: \_ | 下移 N-1 行，光标将位于第一个非空白字符上                    |
| :white_check_mark: | :1234: G  | 移动到第N行，光标将位于第一个非空白字符上(default: 最后一行)   |
| :white_check_mark: | :1234: gg | 移动到第N行，光标将位于第一个非空白字符上(default: 第一行)     |
...
| Status             | Command       | Description                                    |
| ------------------ | ------------- | ---------------------------------------------- |
| :white_check_mark: | :1234: CTRL-E | 向下滚动N行(default: 1)         |
| :white_check_mark: | :1234: CTRL-D | 向下滚动N个1/2屏(default: 1/2 屏)|
| :white_check_mark: | :1234: CTRL-F | 向下滚动N屏 |
| :white_check_mark: | :1234: CTRL-Y | 向上滚动N行(default: 1)            |
| :white_check_mark: | :1234: CTRL-U | 向上滚动N个1/2屏(default: 1/2 屏)   |
