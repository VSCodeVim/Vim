...
suite('foldFix', () => {
  ...
  newTest({
    ...
    start: Object.assign([...lines], { 6: '|region3' }),
  ...
  newTest({
    title:
      'insert mode: j and k move over folded regions without unfolding',
    start: Object.assign([...lines], { 0: cursorStartOfRegion1 }),
    keysPressed:
      foldAllHotKey +
      'i' +
  ...
  newTest({
    title:
      'visual line mode: repeat prefixed j and k move over folded regions without unfolding',
    start: Object.assign([...lines], { 0: cursorStartOfRegion1 }),
    keysPressed: foldAllHotKey + 'V5j4k2jc' + 'replaced',
    end: Object.assign(
      [region3, foldedLine3a, unfoldedLine3a, region4, foldedLine4a],
      { 0: 'replaced|' }
    )
  });
  ...
  newTest({
    ...
    start: Object.assign([...lines], { 0: '|region1 line wrapped onto 3' }),
