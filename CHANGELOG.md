...
- Progressive increment/decrement (`g<C-a>`/`g<C-x>`) [\#5020](https://github.com/VSCodeVim/Vim/issues/3226)
...
- Support `:jumps` command [\#4872](https://github.com/VSCodeVim/Vim/issues/4872)
...
- add :sh command [\#5040](https://github.com/VSCodeVim/Vim/pull/5040) ([zimio](https://github.com/zimio))
